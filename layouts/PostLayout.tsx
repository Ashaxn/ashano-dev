        ...
        <article>
          <header className="relative">
            {images ? (
              ...
              <div className="bg-emerald-400 w-full h-96 rounded-lg" />
            )}
            <div className="space-y-1 text-left absolute bottom-0 left-0 p-6 bg-gradient-to-t from-emerald-600 w-full rounded-b-lg">
              <div>
