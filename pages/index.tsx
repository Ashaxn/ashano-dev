        ...
        <div className="py-10 space-y-2 rounded-lg md:space-y-5">
          <div className="flex flex-col space-y-3">
            ...
            <p className="text-lg leading-7 text-gray-800 dark:text-white">
              ...
              <span className="font-bold text-emerald-500 ml-3 hover:text-emerald-600 dark:hover:text-emerald-700">
            ...
            return (
              <li key={slug} className="py-2">
                <Link href={`/blog/${slug}`} aria-label={`Read "${title}"`}>
                  <article className="rounded-md space-y-2 hover:bg-gray-200 hover:bg-opacity-50 gap-3 xl:grid xl:grid-cols-4 xl:space-y-0 xl:items-baseline bg-gray-200 bg-opacity-25 dark:bg-zinc-900  dark:hover:bg-zinc-800 p-5">
